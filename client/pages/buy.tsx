						...
						<div className='flex flex-col md:flex-row -mx-4'>
							...
							<div className='md:flex-1 px-4'>
								...
								<div className='flex items-center space-x-4 my-4'>
									<div>
										<div className='rounded-lg bg-gray-100 flex py-2 px-3'>
											<span className=' text-primary mr-1 mt-1'>
												ETH
											</span>
								...
								<p className=' text-tertiary '>
									CommuniCoin is a community-focused token
									that enables users to vote on community
									decisions and activities. It allows for
									greater participation and democracy within
									communities, giving users a say in the
