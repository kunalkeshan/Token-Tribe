...
export default function About() {
	return (
		<PublicLayout>
			...
			<div className='2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 w-full'>
				<div className='flex flex-col lg:flex-row justify-between gap-8'>
					<div className='w-full  flex flex-col justify-center max-w-[1240px] mx-auto'>
						<h1 className='text-3xl font-primary lg:text-4xl font-bold leading-9 text-secondary pb-4'>
							About Us
						</h1>
